...
- [GitHub for Rstan](https://github.com/betanalpha/knitr_case_studies/tree/master/principled_bayesian_workflow)
- [GitHub for Pystan](https://github.com/betanalpha/jupyter_case_studies/tree/master/principled_bayesian_workflow)
- I'll do a largely conceptual introduction and work through a "toyed down" example. [Files on Github.](https://github.com/KeithORourke/BayesinWorkflowLecture)
...
- Currently an author on [Statistical Modeling, Causal Inference, and Social Science](https://statmodeling.stat.columbia.edu/author/keithor/) a mostly Bayesian perspective blog. 
...
- Think of learning about an object just from the shadows it casts while being unable to look directly at the object. We see those shadows but really are only interested in what is casting them. They may look very scary, but the object casting them maybe mice. 
...
- Two stage simulation is the just the Bayesian version of generating realistic? fake universes!
...
Lets try to see the adequacy of joint model issue in plots.
========================================================
...
- Often a good idea to used different joint model to create *wronger* fake universes for the joint model been used in the analysis.
...
- Some argue only look at the first (which has advantages especialy with many parameters) while I would look at both. 
...
- Still some resistence to assessing the adequacy of the data?
...
- Sometimes it is hard to know when you have adequate data but one of the premises is obviously false ane *should* be fixed.
...
- See [Stan Prior Choice Recommendations wiki.](https://github.com/stan-dev/stan/wiki/Prior-Choice-Recommendations)
...
Model Sensitivity: Generic Posterior Shrinkage (1 - post.var/prior.var) and z-Scores ((post.mean - truth)/post.sd
========================================================
...
- [FDA 2010 guidance for doing simulations to obtain operating characteristics](https://www.fda.gov/media/71512/download)
